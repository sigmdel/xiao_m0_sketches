...
This is not a fork of the original library; documentation and all but 2 fonts 
 have been removed from the library for demonstration purposes.

 Please use the original SSD1306Ascii library by Bill Greiman (greiman)
