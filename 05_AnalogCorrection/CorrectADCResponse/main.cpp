/*
  This sketch easily and quickly finds the right ADC correction values for SAM D21/D51 based boards.
...
/*
  ...
  1) Remove any connection cable, shield or jumper from your SAM D21 or SAM D51 board
  ...
  4) Connect the board to your PC using a USB cable plugged in the USB programming port of the board
  5) Upload this sketch and leave the board powered on for at least one minute
  6) Open the Serial Monitor and press the reset button on the SAM Dx1 board
