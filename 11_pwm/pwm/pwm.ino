/*
  ...
  A sketch changing the intensity of on board LEDs of Seeeduino XIAO
  with pulse width modulation.
  
  Based on Fade.ino, File/Examples/Basic/Fade
 ...
 *
 *
 * Copyright 2022, Michel Deslierres. No rights reserved, this code is in the public domain.
